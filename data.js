const portfolioData = {
    ...
    stats: [
        ...
        { val: "$50k+", label: "Revenue Impact" },
        { val: "Python", label: "Expertise" }
    ],
    approach: {
        title: "My Approach",
        ...
        cards: [
            { icon: "brain-circuit", title: "Machine Learning", desc: "Clustering, Classification, Regression for predictive modeling to forecast trends and automate decisions." },
            { icon: "message-square-text", title: "NLP Analysis", desc: "Sentiment Analysis to understand customer behavior from text, reviews, and social media data." },
            { icon: "pie-chart", title: "Visualization", desc: "Interactive Power BI dashboards for KPIs & Sales tracking that tell a clear story behind the numbers." },
            { icon: "database", title: "Advanced SQL", desc: "Complex JOINs, CTEs, and Window Functions for robust data mining and efficient ETL processes." }
        ]
    },
    experience: [
        { 
    ...
    // FOTO MANUAL (EXTRA) - Nanti bisa ditambah lewat Admin
    gallery: [
        {
            img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1000&auto=format&fit=crop",
    ...
    footer: {
        copyright: "&copy; 2024 Luqfi Anita Rahman. Built with <i data-lucide='heart' size='12' style='color: red; display: inline;'></i> & Data.",
        linkedin: "#",
        github: "#",
        instagram: "#"
    }
